	...
	namespace string {
		...
		class TextLine {
		  public:
			...
			TextLine &operator=(const Utf8String &line);
			TextLine &operator=(const std::string &line) { return operator=(Utf8String {line}); }
			bool operator==(const Utf8StringView &line);
		  ...
		  protected:
			...
			bool InsertString(const Utf8StringView &str, CharOffset charOffset);
