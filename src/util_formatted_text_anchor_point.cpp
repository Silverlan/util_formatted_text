...
LineStartAnchorPoint *AnchorPoint::GetParent() { return m_parent.IsValid() ? static_cast<LineStartAnchorPoint *>(m_parent.Get()) : nullptr; }
...
bool AnchorPoint::IsAttachedToLine(FormattedTextLine &line) const { return (m_wpLine.expired() == false) && m_wpLine.lock().get() == &line; }
...
void LineStartAnchorPoint::ClearNextLineAnchorStartPoint() { m_nextLineAnchorStartPoint = decltype(m_nextLineAnchorStartPoint) {}; }
LineStartAnchorPoint *LineStartAnchorPoint::GetNextLineAnchorStartPoint() { return m_nextLineAnchorStartPoint.IsExpired() ? nullptr : static_cast<LineStartAnchorPoint *>(m_nextLineAnchorStartPoint.Get()); }
void LineStartAnchorPoint::ClearPreviousLineAnchorStartPoint() { m_prevLineAnchorStartPoint = decltype(m_nextLineAnchorStartPoint) {}; }
